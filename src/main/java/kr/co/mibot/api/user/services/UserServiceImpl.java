package kr.co.mibot.api.user.services;

import kr.co.mibot.api.auth.configs.AuthProvider;
import kr.co.mibot.api.auth.domains.Messenger;
import kr.co.mibot.api.auth.exception.SecurityRuntimeException;
import kr.co.mibot.api.user.domains.Role;
import kr.co.mibot.api.user.domains.User;
import kr.co.mibot.api.user.domains.UserDTO;
import kr.co.mibot.api.user.repositories.UserRepository;
import kr.co.mibot.api.common.datastructure.Box;
...
import static kr.co.mibot.api.common.lambdas.Lambda.*;
